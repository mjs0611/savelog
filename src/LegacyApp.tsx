...
import { initBannerAds } from './lib/ads';
...
import { getTodayStr, getWeekKey, formatAmount } from './lib/utils';
...
export default function App() {
  ...
  if ((!anonymousKey || !tossLinked) && import.meta.env.PROD) {
    const isMigration = !!getUserKey() || streak.totalDays > 0;
    return (
      <div className="app-root">
        <div className="screen setup-screen">
          <div className="setup-hero">
            ...
            {isMigration ? (
              <p className="setup-desc">공개 기록을 이어서 볼 수 있게<br />토스 계정에 연결해 둘게요</p>
            ) : (
  ...
  return (
    <div className="app-root">
      ...
      {/* 상태 안내 토스트 */}
      {toastMessage && (
        <div className="point-toast">{toastMessage}</div>
      )}
