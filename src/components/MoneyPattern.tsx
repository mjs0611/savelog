  ...
  return (
    <div className="money-pattern">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        ...
        <span style={{ fontSize: '11px', fontWeight: 800, padding: '3px 8px', borderRadius: '100px', background: 'rgba(31, 30, 28, 0.08)', color: 'var(--primary)' }}>
          {a.persona.badge}
        </span>
      </div>
      ...
      <div className="money-pattern-stats">
        <div className="money-pattern-stat">
          ...
          <span className="money-pattern-stat-value" style={{ color: a.savedTotal > 0 ? '#059669' : 'inherit' }}>
